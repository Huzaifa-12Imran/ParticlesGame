...
const levels = [
  ...
  },
  {
    ...
    playerObstacles: [
      { type: 'ramp', x: -2, z: -3, params: { width: 8, depth: 3, height: 0.35, elevation: 8, rotX: -0.3 } },
      { type: 'ramp', x: 4, z: 3, params: { width: 6, depth: 2.5, height: 0.35, elevation: 5, rotX: -0.2 } },
    ],
  },
  {
    name: "Zigzag Path",
    ...
    playerObstacles: [
      { type: 'ramp', x: -6, z: -6, params: { width: 7, depth: 3, height: 0.35, elevation: 12, rotX: -0.3, rotY: 0.5 } },
      { type: 'ramp', x: 2, z: -2, params: { width: 7, depth: 3, height: 0.35, elevation: 8, rotX: -0.25, rotY: 0.3 } },
      { type: 'ramp', x: 6, z: 5, params: { width: 6, depth: 2.5, height: 0.35, elevation: 4, rotX: -0.2 } },
    ],
  },
  {
    name: "The Cascade",
  ...
  },
  {
    ...
    fixedObstacles: [
      { type: 'box', x: 0, z: 0, params: { width: 1, height: 10, depth: 20 } },
    ],
    playerObstacles: [
      { type: 'ramp', x: 0, z: 0, params: { width: 10, depth: 4, height: 0.35, elevation: 11, rotX: -0.15, rotZ: 0.3 } },
    ],
  },
  {
    name: "The Gauntlet",
    ...
    fixedObstacles: [
      ...
      { type: 'box', x: 6, z: -6, params: { width: 3, height: 4, depth: 1 } },
      { type: 'cylinder', x: 0, z: 0, params: { radius: 2, height: 5 } },
      { type: 'box', x: -8, z: 6, params: { width: 1, height: 3, depth: 6 } },
      { type: 'box', x: 8, z: 6, params: { width: 1, height: 3, depth: 6 } },
      { type: 'sphere', x: -3, z: 8, params: { radius: 1.5 } },
      { type: 'sphere', x: 3, z: 8, params: { radius: 1.5 } },
    ],
    playerObstacles: [
      { type: 'ramp', x: 0, z: -8, params: { width: 10, depth: 3, height: 0.35, elevation: 15, rotX: -0.2 } },
      { type: 'ramp', x: -4, z: -2, params: { width: 7, depth: 3, height: 0.35, elevation: 10, rotX: -0.25, rotY: 0.4 } },
      { type: 'ramp', x: 4, z: -2, params: { width: 7, depth: 3, height: 0.35, elevation: 10, rotX: -0.25, rotY: -0.4 } },
      { type: 'ramp', x: 0, z: 5, params: { width: 8, depth: 3, height: 0.35, elevation: 5, rotX: -0.15 } },
    ],
  },
  {
    name: "Pendulum Alley",
    ...
    fixedObstacles: [
      ...
      { type: 'box', x: 0, z: -6, params: { width: 6, height: 3, depth: 1 } },
    ],
    playerObstacles: [
      { type: 'ramp', x: 0, z: -9, params: { width: 9, depth: 3, height: 0.35, elevation: 15, rotX: -0.25 } },
      { type: 'ramp', x: -3, z: 0, params: { width: 7, depth: 2.5, height: 0.35, elevation: 9, rotX: -0.2, rotY: 0.3 } },
      { type: 'ramp', x: 3, z: 6, params: { width: 7, depth: 2.5, height: 0.35, elevation: 5, rotX: -0.2, rotY: -0.3 } },
    ],
  },
  {
    name: "Narrow Funnel",
    ...
    fixedObstacles: [
      ...
      { type: 'box', x: 5, z: -3, params: { width: 2, height: 5, depth: 2 } },
    ],
    playerObstacles: [
      { type: 'ramp', x: -4, z: -4, params: { width: 7, depth: 3, height: 0.35, elevation: 13, rotX: -0.3, rotY: 0.4 } },
      { type: 'ramp', x: 2, z: 0, params: { width: 6, depth: 2.5, height: 0.35, elevation: 8, rotX: -0.25, rotY: 0.5 } },
      { type: 'ramp', x: 6, z: 5, params: { width: 5, depth: 2, height: 0.35, elevation: 4, rotX: -0.25, rotY: 0.3 } },
    ],
  },
  {
    name: "Twin Chutes",
    ...
    fixedObstacles: [
      ...
      { type: 'sphere', x: 0, z: 6, params: { radius: 1.8 } },
    ],
    playerObstacles: [
      { type: 'ramp', x: -5, z: -8, params: { width: 6, depth: 3, height: 0.35, elevation: 16, rotX: -0.25, rotY: 0.3 } },
      { type: 'ramp', x: 5, z: -8, params: { width: 6, depth: 3, height: 0.35, elevation: 16, rotX: -0.25, rotY: -0.3 } },
      { type: 'ramp', x: 0, z: -2, params: { width: 7, depth: 3, height: 0.35, elevation: 9, rotX: -0.2 } },
    ],
  },
  {
    name: "The Crucible",
    ...
    playerObstacles: [
      { type: 'ramp', x: 0, z: -9, params: { width: 10, depth: 3, height: 0.35, elevation: 17, rotX: -0.25 } },
      { type: 'ramp', x: -4, z: -3, params: { width: 6, depth: 2.5, height: 0.35, elevation: 11, rotX: -0.2, rotY: 0.4 } },
